...
<section class="product spad">
    ...
    <div class="container">
        ...
        <div class="row property_gallery">
            ...
            ?>
                <div style="width: 100%;" class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product_item">
                        ...
                        <div class="product_item_text">
                            ...
                            <div class="product_price"><?php echo $allproduct['price'] . 'đ'; ?></div>
                            <div class="rating">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="product_item">
                    ...
                    <div class="product_item_text">
                        ...
                        <div class="product_price">590.000đ<span>400.000đ</span></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6">
